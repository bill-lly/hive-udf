...
@org.apache.hadoop.hive.ql.exec.Description(name = "get_decrypt_string", value = "_FUNC_(arguments) - This function " +
        "is designed to decrypt data using the Base64 decoding algorithm. It is a simple yet powerful tool that is " +
        "widely used to transmit and store data securely. By applying this function, you can easily convert Base64 " +
        "encoded data back to its original form, which is essential for various applications such as data analysis, " +
        "web development, and computer security. With its user-friendly interface and intuitive design, this " +
        "decryption function is perfect for both novice and advanced users.")
public class GenericUDFGetDecryptString extends GenericUDF {
    ...
    public String getDisplayString(String[] children) {
        return getStandardDisplayString(GenericUDFGetDecryptString.class.getName(), children);
    }
