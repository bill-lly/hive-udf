...
@org.apache.hadoop.hive.ql.exec.Description(name = "explode_json_array", value = "_FUNC_(a) - separates the elements " +
        "of json array a into multiple rows;")
